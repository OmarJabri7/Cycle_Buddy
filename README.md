...
a. On the left, we have the results from the indoor testing, where the car plate is displayed on a phone screen.<br>
b. On the right, we have the results from the outdoor testing, where the car plate is captured by the camera on the streets of Glasgow.<br>
